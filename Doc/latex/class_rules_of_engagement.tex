...
\hypertarget{class_rules_of_engagement_a81832aa421c58fe508e3ace862e1288e}{\index{Rules\-Of\-Engagement@{Rules\-Of\-Engagement}!relation\-Family@{relation\-Family}}
\index{relation\-Family@{relation\-Family}!RulesOfEngagement@{Rules\-Of\-Engagement}}
...
Definition at line 148 of file Rules\-Of\-Engagement.\-h.
...
Definition at line 152 of file Rules\-Of\-Engagement.\-h.
...
\hypertarget{class_rules_of_engagement_a82a4e55b543189f43f270cb32b7f9e49}{\index{Rules\-Of\-Engagement@{Rules\-Of\-Engagement}!convert\-Argument\-To\-Integer@{convert\-Argument\-To\-Integer}}
...
)\hspace{0.3cm}{\ttfamily [static]}}}\label{class_rules_of_engagement_a82a4e55b543189f43f270cb32b7f9e49}
Method that helps to convert an argument to the correct value to be stored in \hyperlink{class_answer_table}{Answer\-Table}. To be used for relations. 
\begin{DoxyParams}{Parameters}
{\em type} & type of relation \\
\hline
{\em first} & whether the argument is the first or second argument \\
\hline
{\em arg} & argument to be converted \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
the integer representing the argument 
\end{DoxyReturn}


Definition at line 345 of file Rules\-Of\-Engagement.\-cpp.

\hypertarget{class_rules_of_engagement_a3d3457698b69480b4aa5173177a5c439}{\index{Rules\-Of\-Engagement@{Rules\-Of\-Engagement}!convert\-Integer\-To\-Argument@{convert\-Integer\-To\-Argument}}
\index{convert\-Integer\-To\-Argument@{convert\-Integer\-To\-Argument}!RulesOfEngagement@{Rules\-Of\-Engagement}}
\subsubsection[{convert\-Integer\-To\-Argument}]{\setlength{\rightskip}{0pt plus 5cm}string Rules\-Of\-Engagement\-::convert\-Integer\-To\-Argument (
\begin{DoxyParamCaption}
\item[{const {\bf Query\-Var}}]{type, }
\item[{const int}]{integer}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}}\label{class_rules_of_engagement_a3d3457698b69480b4aa5173177a5c439}
Method that helps to convert the value stored in \hyperlink{class_answer_table}{Answer\-Table} to the proper description. 
\begin{DoxyParams}{Parameters}
{\em type} & type of synonym \\
\hline
{\em integer} & integer to be converted \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
the string that the integer was representing 
\end{DoxyReturn}


Definition at line 384 of file Rules\-Of\-Engagement.\-cpp.
...
The reason for the shortness of the code in \hyperlink{class_multi_query_eval}{Multi\-Query\-Eval}. Takes in the relation type and returns a function pointer that can be called to evaluate the satisfiablilty of the two arguments. 
\begin{DoxyParams}{Parameters}
{\em rel} & type of relation \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
Definition at line 422 of file Rules\-Of\-Engagement.\-cpp.

\hypertarget{class_rules_of_engagement_ade5428f4b20d617254bedff1b5a43648}{\index{Rules\-Of\-Engagement@{Rules\-Of\-Engagement}!get\-Relation\-By\-Family@{get\-Relation\-By\-Family}}
\index{get\-Relation\-By\-Family@{get\-Relation\-By\-Family}!RulesOfEngagement@{Rules\-Of\-Engagement}}
\subsubsection[{get\-Relation\-By\-Family}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Rules\-Of\-Engagement\-::relation\-Family} Rules\-Of\-Engagement\-::get\-Relation\-By\-Family (
\begin{DoxyParamCaption}
\item[{{\bf Query\-Relations}}]{rel}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}}\label{class_rules_of_engagement_ade5428f4b20d617254bedff1b5a43648}
The reason for the shortness of the code in \hyperlink{class_multi_query_eval}{Multi\-Query\-Eval}. Takes in the relation type and returns a function pointer that can be called to return a list of values that satisfy the relation. e.\-g. get\-Relation\-By\-Family(rel)(x) -\/$>$ list of y such that rel(x, y) is true 
\begin{DoxyParams}{Parameters}
{\em rel} & type of relation \\
\hline
\end{DoxyParams}
...
Definition at line 510 of file Rules\-Of\-Engagement.\-cpp.

\hypertarget{class_rules_of_engagement_abcaa96fcf051ed0e5b9cb9cfbbab4e55}{\index{Rules\-Of\-Engagement@{Rules\-Of\-Engagement}!get\-Relation\-From\-Family@{get\-Relation\-From\-Family}}
\index{get\-Relation\-From\-Family@{get\-Relation\-From\-Family}!RulesOfEngagement@{Rules\-Of\-Engagement}}
\subsubsection[{get\-Relation\-From\-Family}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Rules\-Of\-Engagement\-::relation\-Family} Rules\-Of\-Engagement\-::get\-Relation\-From\-Family (
\begin{DoxyParamCaption}
\item[{{\bf Query\-Relations}}]{rel}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}}\label{class_rules_of_engagement_abcaa96fcf051ed0e5b9cb9cfbbab4e55}
The reason for the shortness of the code in \hyperlink{class_multi_query_eval}{Multi\-Query\-Eval}. Takes in the relation type and returns a function pointer that can be called to return a list of values that satisfy the relation. e.\-g. get\-Relation\-From\-Family(rel)(y) -\/$>$ list of x such that rel(x, y) is true 
\begin{DoxyParams}{Parameters}
{\em rel} & type of relation \\
\hline
\end{DoxyParams}
...
Definition at line 597 of file Rules\-Of\-Engagement.\-cpp.
...
Takes in the synonym type and returns a function that when called, will produce all values that are of that synonym type, in integer form. 
\begin{DoxyParams}{Parameters}
{\em rel} & type of variable \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
the function pointer 
...
Definition at line 688 of file Rules\-Of\-Engagement.\-cpp.
...
Definition at line 32 of file Rules\-Of\-Engagement.\-cpp.

\hypertarget{class_rules_of_engagement_a7e5a03b2d97eaf0ae5ba44ad6b0a2fe5}{\index{Rules\-Of\-Engagement@{Rules\-Of\-Engagement}!is\-Exist\-Type@{is\-Exist\-Type}}
\index{is\-Exist\-Type@{is\-Exist\-Type}!RulesOfEngagement@{Rules\-Of\-Engagement}}
\subsubsection[{is\-Exist\-Type}]{\setlength{\rightskip}{0pt plus 5cm}bool Rules\-Of\-Engagement\-::is\-Exist\-Type (
\begin{DoxyParamCaption}
\item[{{\bf Rules\-Of\-Engagement\-::\-Query\-Var}}]{var}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}}\label{class_rules_of_engagement_a7e5a03b2d97eaf0ae5ba44ad6b0a2fe5}
Method that determines if there exists any of assign/while/if in the program. 
\begin{DoxyParams}{Parameters}
{\em var} & type of variable \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
true if there exists such a variable 
\end{DoxyReturn}


Definition at line 402 of file Rules\-Of\-Engagement.\-cpp.
...
This method will be used to check whether this assignment is valid with the pattern being checked 
\begin{DoxyParams}{Parameters}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
true if the assignment satisfied the pattern, and false otherwise 
\end{DoxyReturn}


Definition at line 790 of file Rules\-Of\-Engagement.\-cpp.
