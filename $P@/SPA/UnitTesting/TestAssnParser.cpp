...
{  
	...
	PKB::variables.insertVAR("x1");
	PKB::variables.insertVAR("x2");
	PKB::variables.insertVAR("y1");
	PKB::variables.insertVAR("y2");
	PKB::variables.insertVAR("left");
	PKB::variables.insertVAR("right");
	...
	ASTNode* plus = dynamic_cast<ASTExprNode* >(opr->getChild(0));
	CPPUNIT_ASSERT_EQUAL(ASTNode::NodeType::Operator, opr->getType()); //+
	CPPUNIT_ASSERT_EQUAL(getOprType("+"), opr->getValue());

	CPPUNIT_ASSERT_EQUAL(ASTNode::NodeType::Variable, opr->getChild(0)->getType()); //x1
	CPPUNIT_ASSERT_EQUAL(getOprType("x1"), opr->getValue());
